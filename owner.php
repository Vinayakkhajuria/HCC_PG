...
//             Don't have an account? <a href="ownersignup.php" class="signup-link">Signup</a>
//           </div>
//           <form action="C:\Users\DELL\Desktop\PG_search\pg-finder2-main\dashboard.html">
         
//           <button type="submit" class="btn btn-block btn-primary" onclick="owner_details.html">Login</button>
//           </form>
//         </form>
//       </div>
//     </div>
